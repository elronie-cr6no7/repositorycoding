...
def main():
    chrome_options = Options()  # Buat objek Options
    chrome_options.add_argument("--headless")  # Mode tanpa tampilan
    driver = webdriver.Chrome(options=chrome_options)  # Gunakan options dalam inisialisasi driver
...
# Jadwal untuk menjalankan tugas setiap 2 jam dari pukul 00:30 WIB hingga 22:30 WIB
...
while True:
    ...
    print(f"Menjalankan tugas pada: {current_time}")
    time.sleep(900)
