...
# Set PATH environment variable to include the directory with msedgedriver.exe
...
def update_google_sheet(username, password, ird_ip, spreadsheet_url):
    ...
    # Print data sebelum mengirimkannya ke Google Spreadsheet
    print("Signal Level:", ird_data[0])
    print("CNR:", ird_data[1])
    print("BER:", ird_data[2])
    print("CNR Margin:", ird_data[3])
    
    print_status(f"Data berhasil diperbarui: {data}")
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            print_status(f"Terjadi kesalahan: {e}")
